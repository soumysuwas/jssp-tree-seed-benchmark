...
40 Sahman Table 5 instances x 20 seeds (0-19), MaxFEs = D*1000, NS=6, ST=0.5, sampler C1.
...
OUT = HERE.parent / "results" / "dtsa" / "dtsa_jssp.csv"
...
def one(instance: str, seed: int, n_trees):
    jcfg = JSSPConfig(n_trees=n_trees, use_local_search=True, symmetry_sampler="C1")
